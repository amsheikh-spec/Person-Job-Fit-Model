...
def main():
    jd = pd.read_csv("data\job_description.csv")
    jd.head(5)
    ...
    jd_filtered.to_csv('processed data/preprocessed_jd.csv', index=False)

if __name__ == "__main__":
    main()
    print("Successfully Processed the Job Description data")